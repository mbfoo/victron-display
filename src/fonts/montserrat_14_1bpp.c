 ...
 * Size: 14 px
 * Bpp: 1
 * Opts: --bpp 1 --size 14 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --range 32-127,8226 --format lvgl -o montserrat_14_1bpp.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 282, .adv_w = 162, .box_w = 9, .box_h = 10, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 688, .adv_w = 147, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    ...
    {.bitmap_index = 854, .adv_w = 80, .box_w = 4, .box_h = 3, .ofs_x = 1, .ofs_y = 2}
};
